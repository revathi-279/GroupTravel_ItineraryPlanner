...
import { Edit3, MapPin, Calendar, AlignLeft, X, AlertCircle } from "lucide-react";
...
const EditEventModal = ({ open, onClose, itinerary, trip, onUpdated }) => {
  ...
  // Helper utility to safely format raw ISO strings into local datetime-local format
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      dateTime: formatForInput(itinerary.dateTime),
    });
    setErrors({});
  }, [itinerary]);
  ...
  const validate = () => {
    ...
    // Normalize end date boundaries to cover full end of day
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-white rounded-3xl shadow-2xl border border-gray-100 p-6 md:p-8 z-10 font-sans antialiased animate-in fade-in zoom-in-95 duration-150">
        ...
        {/* Absolute Top-Right Close Action Trigger Button */}
        <button
          onClick={onClose}
        ...
        <div className="mb-6 pr-8">
          ...
          <p className="text-xs text-gray-400 leading-relaxed">
            Modify coordination items, update lodgings or schedule times adjustments seamlessly on your timeline.
          </p>
        </div>

        {/* Core Input Form Component */}
        <form onSubmit={handleSubmit} className="space-y-4">
          
          {/* Form Row Field: Event Name */}
          ...
          <div className="space-y-1.5">
            ...
            <input
              type="text"
              name="location"
              placeholder="e.g., Vrindavan Palace Grounds"
          ...
          {/* Form Row Field: Timestamp Pickers */}
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold uppercase tracking-wider text-gray-400 flex items-center gap-1.5">
            ...
            {/* Visual Boundary Layout Meta Helper */}
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-2.5 text-[11px] font-medium text-gray-400 select-none">
          ...
          {/* Form Row Field: Optional Notes Textarea */}
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold uppercase tracking-wider text-gray-400 flex items-center gap-1.5">
            ...
            <textarea
              name="description"
              placeholder="Add reference notes, meeting guidelines, links or tickets details..."
              rows={3}
          ...
          {/* Bottom Action Footer Options Row */}
